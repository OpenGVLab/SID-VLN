...
def calc_position_distance(a, b):#finish
    # a, b: (x, y, z)
    dx = b[0] - a[0]
    dy = b[1] - a[1]
    dz = b[2] - a[2]
...
def calculate_vp_rel_pos_fts(a, b, base_heading=0, base_elevation=0):#finish
    # a, b: (x, y, z)
    dx = b[0] - a[0]
    dy = b[1] - a[1]
    dz = b[2] - a[2]
...
class GraphMap(object):
    def __init__(self, start_vp):
        ...
        self.node_step_ids = {} #key: vp, value: num_step

    def update_graph(self, ob):#finish
