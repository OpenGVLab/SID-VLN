...
def parse_args():
    ...
    parser.add_argument("--aug_times", default=1)
    parser.add_argument("--rvr_times", default=1)
...
def postprocess_args(args):
    ...
    ft_file_map = {
        ...
        'mae': 'img_goal_vit_base_patch16_224.mae.hdf5',
        'siglip': 'siglip_base.hdf5',
        'dinov2': 'dinov2_base.hdf5',
    }
    if 'mae' in args.features:
        args.img_ft_files = [os.path.join(ROOTDIR, 'REVERIE', 'features', ft_file_map['vitbase']), os.path.join(ROOTDIR, 'REVERIE', 'features', ft_file_map['mae'])]
    else:
        args.img_ft_files = [os.path.join(ROOTDIR, 'REVERIE', 'features', ft_file_map['siglip']), os.path.join(ROOTDIR, 'REVERIE', 'features', ft_file_map['dinov2'])]
    ...
    # Build paths
    # args.output_dir = os.path.join(args.output_dir, f'{args.scan}')
